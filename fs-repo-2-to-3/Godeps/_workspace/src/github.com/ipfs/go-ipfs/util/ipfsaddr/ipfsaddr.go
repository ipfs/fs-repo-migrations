...
import (
	...
	peer "github.com/ipfs/fs-repo-migrations/fs-repo-2-to-3/Godeps/_workspace/src/github.com/ipfs/go-ipfs/p2p/peer"
	eventlog "github.com/ipfs/fs-repo-migrations/fs-repo-2-to-3/Godeps/_workspace/src/github.com/ipfs/go-ipfs/thirdparty/eventlog"
	ma "github.com/ipfs/fs-repo-migrations/fs-repo-2-to-3/Godeps/_workspace/src/github.com/jbenet/go-multiaddr"
)

var log = // ErrInvalidAddr signals an address is not a valid ipfs address.
eventlog.Logger("ipfsaddr")
