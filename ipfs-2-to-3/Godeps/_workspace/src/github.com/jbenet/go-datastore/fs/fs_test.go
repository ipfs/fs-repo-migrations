...
import (
	...
	fs "github.com/ipfs/fs-repo-migrations/ipfs-2-to-3/Godeps/_workspace/src/github.com/jbenet/go-datastore/fs"
	query "github.com/ipfs/fs-repo-migrations/ipfs-2-to-3/Godeps/_workspace/src/github.com/jbenet/go-datastore/query"
)

func Test(t *testing. // Hook up gocheck into the "go test" runner.
T) { TestingT(t) }
