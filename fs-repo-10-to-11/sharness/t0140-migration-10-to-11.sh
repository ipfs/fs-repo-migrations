...
test_description="Migration 10 to 11 with pins"

GUEST_IPFS_10_TO_11="sharness/bin/fs-repo-10-to-11"
...
test_expect_success "'ipfs init' succeeds" '
	exec_docker "$DOCID" "IPFS_PATH=/root/.ipfs ipfs init" >actual 2>&1 ||
	test_fsh cat actual
'
...
test_expect_success "'fs-repo-10-to-11' works" '
	exec_docker "$DOCID" "$GUEST_IPFS_10_TO_11 -verbose -path=/root/.ipfs" >actual
'

test_expect_success "'fs-repo-10-to-11' output looks good" '
...
test_expect_success "'fs-repo-10-to-11 -revert' output looks good" '
